...
def email_sender(email_title, email_from, email_to, email_body):
    msg = EmailMessage()
    msg['Subject'] = email_title
    msg['From'] = email_from # python@mrartful.com
    msg['To'] = email_to # email from DB
...
email_sender(email_title, 'python@mrartful.com', email_to, email_body)
